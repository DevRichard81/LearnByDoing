...
using Project_Gutenberg.Types.NetworkSocketAsync;

namespace LearnByDoingCli
{
    internal class SampleSocketAsync : SampleShared, ISamples
    {        
        //
        ...
        public SampleSocketAsync()
        {
            ...
            Gutenbergs = new Dictionary<string, IGutenberg>
            {
                ...
                { "Client", new GutenbergAsync().Configuration(config, new SocketConnectionClientAsync()) }
            };
